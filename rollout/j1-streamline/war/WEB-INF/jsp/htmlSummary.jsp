...
<script language="javascript">document.title = "<fmt:message key="summary"/>"</script>

<head><title><fmt:message key="summary"/></title></head>
...
<center>
<img src="images/arrow_backward1.gif" alt="Back to streamlining web tool ..." width=22 height=18> <a href="webTool.htm"><b>[<fmt:message key="back"/>]</b></a>
<br>
<br>

<table align=center border="0px" border-spacing="0px" border-width="0px" cellspacing="0" cellpadding="5" bgcolor="#FFFFFF">
...
<td align="center">
  <c:choose>
  <c:when test="${fieldType.NASAapproved == true}">
...
<td align="center">
  <c:choose>
  <c:when test="${fieldType.CNESapproved == true}">
   <fmt:message key="greenyes"/>
  </c:when>
  <c:otherwise>
   <fmt:message key="redno"/>
