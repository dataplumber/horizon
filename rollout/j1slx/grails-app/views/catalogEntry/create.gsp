                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="gdrArchTime"><g:message code="catalogEntry.gdrDate.label" default="Gdr Archive Date" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: catalogEntryInstance, field: 'gdrArchTime', 'errors')}">
                                    <g:textField name="gdrArchTime" value="${fieldValue(bean: catalogEntryInstance, field: 'gdrArchTime')}" />
                                </td>
                            </tr>
