...
<ROOT>
	<ELEMENT_ITER>
		...
		SORTING='by-expr'
		SORTING_KEY={expr='instanceOf("xs:any") ? callStockSection("Any Element") : \n(ref = getAttrStringValue("ref")) != "" ? ref : callStockSection("QName")',ascending,case_sensitive}
...
<STOCK_SECTIONS>
	...
	<FOLDER>
		...
		<BODY>
			...
			<SS_CALL>
				DESCR='only when the wildcard is defined within this element/complexType/group'
				COND='getBooleanParam("sec.contentElements.xmlSource")\n&&\nstockSection.param.toElement().id == rootElement.id'
				SS_NAME='XML Source'
			</SS_CALL>
		</BODY>
...
CHECKSUM='7nUOeC70fg?doO2L4xAinA'
</DOCFLEX_TEMPLATE>
