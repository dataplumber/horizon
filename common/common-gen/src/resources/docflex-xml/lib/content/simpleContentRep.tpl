...
<STOCK_SECTIONS>
	...
	<FOLDER>
		...
		<ELSE>
			DESCR='if no enumeration facets, look what\'s defined in the embedded type or supertype'
			<SS_CALL>
				DESCR='if there\'s embedded simple type'
...
CHECKSUM='9CJkgOYQDULCaSIUYHbjNw'
</DOCFLEX_TEMPLATE>
