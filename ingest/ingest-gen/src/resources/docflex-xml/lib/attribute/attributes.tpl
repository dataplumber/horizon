...
<ROOT>
	<ELEMENT_ITER>
		...
		SORTING='by-expr'
		SORTING_KEY={expr='instanceOf("xs:anyAttribute")\n  ? callStockSection("Any Attribute")\n  : hasAttr("name") ? callStockSection("Attribute QName") \n                    : getAttrStringValue("ref")',ascending,case_sensitive}
...
<STOCK_SECTIONS>
	...
	<FOLDER>
		...
		<BODY>
			...
			<SS_CALL>
				DESCR='only in the case when the wildcard is defined within this element / attributeGroup / complexType'
				COND='getBooleanParam("sec.attributes.xmlSource") &&\nstockSection.param.toElement().id == rootElement.id'
				SS_NAME='XML Source'
			</SS_CALL>
		</BODY>
...
CHECKSUM='n0mTjI2zlAavum09qSr+qw'
</DOCFLEX_TEMPLATE>
